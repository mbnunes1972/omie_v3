...
| **F2-20** · ACHADO-49, o Remover da etapa 12 herdou a autoridade do PE e a tela cala quando a credencial não vem | **próximo** — achado do Marcelo no percurso do `v2026.09.04-beta1` (04/09); defeito do que o F2-15 entregou 24h antes; duas causas medidas (a autoridade não espelha o upload da própria etapa — subir não pede credencial, remover pede `executar_pe`; e `removerDocCiclo` dá `return` silencioso quando a credencial não vem, o padrão do ACHADO-38 outra vez); a correção tem que ENUMERAR quem mais cai no `else` da rota sem ser subfase do PE, não consertar só a 12 |
