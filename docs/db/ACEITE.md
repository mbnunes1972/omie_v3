...
| 34 | folha paga resolve provisão de comissão de venda (2.1.04.12) sem `VeredictoProvisao` | — (medição, não conserto) | **MEDIDO** — não trava a Conciliação Final (saldo já zerado antes de chegar lá), mas fica sem veredito registrado; decisão do Marcelo em LP-12 (`docs/db/LISTA_PARALELA.md`) |
